      ...
      {options.map((loc) => {
        ...
        return (
          <button
            ...
            className={`min-h-[48px] rounded-xl border px-4 py-3 text-left text-base font-medium touch-manipulation transition-colors ${ selected ? "border-brand-green bg-brand-green text-white" : "border-hairline bg-surface text-ink hover:border-hairline hover:bg-surface-muted" }`}
          >
            {loc.name}
          </button>
        );
