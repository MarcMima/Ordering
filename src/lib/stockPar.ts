...
export const MIN_STOCK_PAR_BY_RAW_NAME: Record<string, StockParRule> = {
  ...
  "rice basmati": { kind: "base", minAmount: 5000 },
  "rice parboiled": { kind: "base", minAmount: 10000 },
  "rice flour": { kind: "base", minAmount: 1000 },
  ...
  "garbage bags blue 145l (roll 20)": { kind: "packs", minPacks: 3 },
  "coca cola": { kind: "packs", minPacks: 2 },
  "coca cola zero": { kind: "packs", minPacks: 2 },
  "still water": { kind: "packs", minPacks: 2 },
  "sparkling water": { kind: "packs", minPacks: 2 },
