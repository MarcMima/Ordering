-- Zorg dat prep_item_ingredients bestaat (als 010 nooit is gedraaid in dit project).
-- Run dit EENMALIG in Supabase SQL Editor vóór 014_bulk_seed_from_recipe_sheet.sql
